...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		if ($category['can_collapse'])
			echo '
								<a class="collapse2" href="', $category['collapse_href'], '">', $category['collapse_image'], '</a>';

		if (!$context['user']['is_guest'] && !empty($category['show_unread']))
			echo '
								<a class="unreadlink hidden-xs" href="', $scripturl, '?action=unread;c=', $category['id'], '">', $txt['view_unread_category'], '</a>';
			...
			foreach ($category['boards'] as $board)
			{
				...
				if (!empty($board['children']))
				{
					...
					foreach ($board['children'] as $child)
					{
						...
						$children[] = $child['new'] ? '<span class="child-ts">' . $child['link'] . '</span>' : $child['link'];
					}
					echo '
	...
	{
		echo '
	<div id="posting_icons" class="floatleft hidden-xs">';
...
function template_info_center()
{
	...
	echo '
		<div class="cat_bar-green">
			<h3 class="catbg cat-green">
		...
		<div class="stats-bg-f" id="upshrinkHeaderIC"', empty($options['collapse_header_ic']) ? '' : ' style="display: none;"', '>
		';
			...
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<i class="fa fa-comments"></i> ', $txt['recent_posts'], '
					</span>
				</h4>
			</div>
			<div class="windowbg_info">
			<div class="hslice" id="recent_posts_content">
				<div class="entry-title" style="display: none;">', $context['forum_name_html_safe'], ' - ', $txt['recent_posts'], '</div>
				<div class="entry-content" style="display: none;">
					<a href="', $scripturl, '?action=.xml;type=webslice">', $txt['subscribe_webslice'], '</a>
				</div>';
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
				echo '
					...
					<dd class="hidden-xs hidden-sm">', $post['time'], '</dd>';
			echo '
				</dl>';
		}
		echo '
	...
	if ($context['show_calendar'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<i class="fa fa-calendar"></i> ', $context['calendar_only_today'] ? $txt['calendar_today'] : $txt['calendar_upcoming'], '
					</span>
				</h4>
			</div>
			<div class="windowbg_info">
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<i class="fa fa-bar-chart"></i> ', $txt['forum_stats'], '
					</span>
				</h4>
			</div>
			<div class="windowbg_info">
	...
	echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						', $context['show_who'] ? '<i class="fa fa-users"></i>' : '', '
						', $txt['online_users'], '
					</span>
				</h4>
			</div>
