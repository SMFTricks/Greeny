				...
				if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
				{
					echo '
							<a href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
								<img src="', $message['member']['avatar']['href'], '" class="img-thumbnail display-profile" alt="*" />
							</a>';
				}
				else
				{
					echo'
							<a href="', $scripturl, '?action=profile;u=', $message['member']['id'], '">
								<img src="',$settings['images_url'] ,'/theme/noavatar.png" class="img-thumbnail display-profile" alt="*" /> 
							</a>';
				}
		...
		echo '
			...
			echo '
							<div class="quickReplyContent">
								<textarea class="form-control" cols="600" rows="7" name="message" tabindex="', $context['tabindex']++, '"></textarea>
							</div>
